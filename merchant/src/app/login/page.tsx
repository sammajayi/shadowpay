...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (merchant) router.push("/dashboard");
  }, [merchant, router]);
  ...
  return (
    <div className="max-w-md mx-auto py-24 text-center">
      ...
      <h1 className="text-heading-sm text-ink">Merchant sign-in</h1>
      <p className="text-body-sm text-smoke mt-3">
        Enter the merchant-scoped API key from your ShadowPay onboarding. This key only ever unlocks your own
        agreements — it cannot decrypt any other merchant&apos;s data.
      </p>
